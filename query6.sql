...
exec newLease('4KUNZY5XOBMTYZH', 'FRXRPJKR17NU391', 8082229885, 8083714311, 'George Smith', 8086431111, 
			TO_DATE('2003-09-08', 'YYYY-MM-DD'), TO_DATE('2016-06-15', 'YYYY-MM-DD'), 10000, 600);